...
public class historico extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        ArrayList <Historico_jogos> hist = null;
        try {
            hist = st.selectHistorico();
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("</tr>");
            for(Historico_jogos h: hist){
                out.println("<tr>");
                out.println("<td>"+h.getData()+"</td>");
                out.println("<td>"+h.getJog1()+"</td>");
                out.println("<td>"+h.getJog2()+"</td>");
                out.println("<td>"+h.getVenc()+"</td>");
                out.println("</tr>");
            }
            out.println("</table>");
            out.println("</body>");
